...
def print_information(df, pred_column, real_column):
    ...
    print("Macro Recall {}".format(precision_score(real_values, predictions, average='macro')))
    print("Macro Precision {}".format(recall_score(real_values, predictions, average='macro')))
